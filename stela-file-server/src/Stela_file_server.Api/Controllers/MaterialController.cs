...
namespace Stela_file_server.Api.Controllers
{
    ...
    public class MaterialController : ControllerBase
    {
        ...
        private readonly string[] _supportedImageExtensions = new string[]
       {
        ...
        [SwaggerOperation(Summary = "Загрузка изображения материала", Description = "Загрузка изображения материала")]
        [SwaggerResponse(StatusCodes.Status200OK, "Изображение материала загружено")]
           ...
           [FromQuery, Required] Guid materialId)
        {
            ...
            _notifyService.Publish(body, ContentUploaded.MaterialImage);
            return Ok();
        }

        [HttpGet("download/{filename}")]
        [SwaggerOperation(Summary = "Скачивание изображения материала", Description = "Скачивание изображения материала")]
        [SwaggerResponse(StatusCodes.Status200OK, "Изображение материала скачано", Type = typeof(FileStreamResult))]
        [SwaggerResponse(StatusCodes.Status404NotFound, "Изображение материала не найдено")]
